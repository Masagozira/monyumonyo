...
public class LeftRightButtonSelection : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _inputActions.UI.LeftSelect.performed += ctx => SelectButton(currentButtonIndex - 1); // 上ボタン
        _inputActions.UI.RightSelect.performed += ctx => SelectButton(currentButtonIndex + 1); // 下ボタン
